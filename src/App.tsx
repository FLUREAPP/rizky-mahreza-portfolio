...
export function App() {
  ...
  return <>
      ...
      <section id="home" className="hero">
        <div className="hero-grid">
          <div className="hero-copy">
            ...
            <div className="hero-meta"><span><MapPin size={16}/> {profile.location}</span><a href={`https://wa.me/${profile.whatsapp}`} target="_blank" rel="noreferrer"><Check size={16}/> WhatsApp available</a></div>
          </div>
    ...
    <footer><div><a className="brand" href="#home"><strong>RM</strong><span><b>{profile.name}</b><small>SENIOR HSE SPECIALIST</small></span></a><p>Executive HSE Portfolio · Pertamina Hulu Rokan working area.</p></div><div className="footer-direct"><b>DIRECT</b><span>WhatsApp <a href={`https://wa.me/${profile.whatsapp}`}>{profile.phone}</a></span><a href={profile.linkedin}>LinkedIn</a></div><a className="back-top" href="#home"><ArrowUp/> Back to top</a></footer>
  </>
}
